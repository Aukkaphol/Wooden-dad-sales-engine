<x-layouts.app title="Edit asset">
    <section class="mx-auto max-w-4xl px-6 py-10">
        <div class="border-b border-white/10 pb-6">
            ...
            <h1 class="mt-3 text-3xl font-semibold text-white">Edit asset</h1>
        </div>

        <form method="POST" action="{{ route('workspaces.assets.update', [$workspace, $asset]) }}" enctype="multipart/form-data" class="mt-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('workspaces.assets.show', [$workspace, $asset]) }}" class="text-sm text-zinc-300 hover:text-white">Cancel</a>
            </div>
        </form>
    </section>
</x-layouts.app>
