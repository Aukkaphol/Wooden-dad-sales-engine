<?php $__env->startSection('content'); ?>
    <section class="bg-pine-50">
        <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="<?php echo e(route('admin.leads.show', $lead)); ?>" class="text-sm font-semibold text-pine-700 hover:text-ink">กลับไปหน้าลูกค้า</a>
                <h1 class="mt-2 text-3xl font-semibold text-ink">สร้างใบเสนอราคา</h1>
                <p class="mt-2 text-sm text-pine-700">ใบเสนอราคา Wooden Dad Design สำหรับ <?php echo e($lead->name); ?></p>
            </div>

            <form action="<?php echo e(route('admin.leads.quotations.store', $lead)); ?>" method="post" class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <dl class="mt-4 space-y-2 text-sm text-pine-700">
                                <div class="flex justify-between gap-4"><dt>ชื่อ</dt><dd class="font-semibold text-ink"><?php echo e($lead->name); ?></dd></div>
                                <div class="flex justify-between gap-4"><dt>เบอร์โทร</dt><dd class="font-semibold text-ink"><?php echo e($lead->phone); ?></dd></div>
                                <div class="flex justify-between gap-4"><dt>จังหวัด</dt><dd class="font-semibold text-ink"><?php echo e($lead->province); ?></dd></div>
                            </dl>
                        </div>
                        <label>
                ...
                <section class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-pine-200">
                    ...
                    <div class="mt-5 space-y-4" data-items>
                        <?php $__currentLoopData = old('items', [['product_name' => 'Bedroom Set M', 'quantity' => 1, 'unit_price' => 0]]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="grid gap-3 rounded-lg bg-pine-50 p-4 md:grid-cols-[1fr_110px_150px_150px_auto]" data-item-row>
                                <label>
                                    ...
                                    <input name="items[<?php echo e($index); ?>][product_name]" value="<?php echo e($item['product_name'] ?? ''); ?>" required class="mt-1 w-full rounded-md border-0 bg-white px-3 py-2 text-sm ring-1 ring-inset ring-pine-200 focus:ring-2 focus:ring-pine-500">
                                </label>
                                <label>
                                    <span class="text-xs font-semibold text-pine-700">จำนวน</span>
                                    <input name="items[<?php echo e($index); ?>][quantity]" type="number" step="0.01" min="0.01" value="<?php echo e($item['quantity'] ?? 1); ?>" required data-quantity class="mt-1 w-full rounded-md border-0 bg-white px-3 py-2 text-sm ring-1 ring-inset ring-pine-200 focus:ring-2 focus:ring-pine-500">
                                </label>
                                <label>
                                    <span class="text-xs font-semibold text-pine-700">ราคาต่อหน่วย</span>
                                    <input name="items[<?php echo e($index); ?>][unit_price]" type="number" step="0.01" min="0" value="<?php echo e($item['unit_price'] ?? 0); ?>" required data-unit-price class="mt-1 w-full rounded-md border-0 bg-white px-3 py-2 text-sm ring-1 ring-inset ring-pine-200 focus:ring-2 focus:ring-pine-500">
                                </label>
                                <div>
                ...
                <section class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-pine-200">
                    <label>
                        ...
                        <textarea name="notes" rows="4" class="mt-2 w-full rounded-md border-0 bg-pine-50 px-3 py-2.5 text-sm ring-1 ring-inset ring-pine-200 focus:ring-2 focus:ring-pine-500"><?php echo e(old('notes')); ?></textarea>
                    </label>
...
<?php echo $__env->make('layouts.app', ['title' => 'สร้างใบเสนอราคา | Wooden Dad Design'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\BEER\Documents\Codex\2026-06-17\create-a-laravel-12-project-named\wooden-dad-sales-engine\resources\views\admin\quotations\create.blade.php ENDPATH**/ ?>