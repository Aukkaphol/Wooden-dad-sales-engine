<?php $__env->startSection('content'); ?>
    ...
    <section class="bg-white">
        <div class="mx-auto flex max-w-6xl flex-col gap-5 px-5 py-12 md:flex-row md:items-center md:justify-between">
            ...
            <a href="<?php echo e(route('lead.create')); ?>" class="inline-flex items-center justify-center rounded-full bg-pine-500 px-6 py-3 font-semibold text-white hover:bg-pine-700">ขอราคาและแบบฟรี</a>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.public', ['title' => 'ชุดห้องนอน | '.company()->display_name], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\BEER\Documents\Codex\2026-06-17\create-a-laravel-12-project-named\wooden-dad-sales-engine\resources\views\bedroom-set.blade.php ENDPATH**/ ?>